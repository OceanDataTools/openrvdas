...
class HapiServerAPI(ServerAPI):
  ...
  def __init__(self):
    ...
    try:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/validate'
  ...
  def get_configuration(self):
    ...
    try:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/config'
      r = requests.get(url, headers=HAPI_HEADERS)
  ...
  def get_active_mode(self):
    """Return cruise config for specified cruise id."""
    try:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/modes?active=true'
      r = requests.get(url, headers=HAPI_HEADERS)
  ...
  def get_modes(self):
    ...
    mode_names = []
    try:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/modes'
      r = requests.get(url, headers=HAPI_HEADERS)
  ...
  def get_loggers(self):
    try:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/loggers'
      r = requests.get(url, headers=HAPI_HEADERS)
  ...
  def get_logger(self, logger_id):
    try:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/loggers?name=' + logger_id
      r = requests.get(url, headers=HAPI_HEADERS)
      return json.loads(r.text)
  ...
  def get_logger_config(self, config_name):
    ...
    try:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/logger_configs?name=' + name
      r = requests.get(url, headers=HAPI_HEADERS)
      response = json.loads(r.text)
    except Exception as err:
      logging.fatal(err)
  ...
  def get_logger_configs(self, mode=None):
    ...
    if not mode:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/logger_configs?active=true'
    else:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/logger_configs?mode=' + mode      
  ...
  def get_logger_config(self, logger_id, mode=None):
    ...
    if not mode:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/logger_configs?active=true&logger=' + logger_id
    else:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/logger_configs?mode=' + mode + '&logger=' + logger_id
  ...
  def set_active_mode(self, mode):
    ...
    try:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/modes/activate?mode=' + mode
      r = requests.get(url, headers=HAPI_HEADERS)
      response = json.loads(r.text)
    except Exception as err:
      logging.fatal(err)
  ...
  def set_active_logger_config(self, logger, config_name):
    ...
    """Set the current mode of the specified cruise in the data store."""
    try:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/loggers/activate_config?logger=' + logger + '&config=' + config_name
      r = requests.get(url, headers=HAPI_HEADERS)
    except Exception as err:
      logging.fatal(err)
  ...
  def update_status(self, status):
    ...
    try:
      url = self.url_protocol + HAPI_SERVER_HOST + ':' + HAPI_SERVER_API_PORT + HAPI_SERVER_PATH + '/api/v1/loggers/update_status'
