...
and configured to run on start up. For the purposes of this guide, we will assume that the OpenRVDAS user you've created during the installation process is named __rvdas__.<br>
