...
################################################################################
class PostgreSQLRecordConnector:
  ...
  def table_exists(self, table_name):
    ...
    cursor = self.connection.cursor()
    exists_cmd = "SELECT * FROM pg_tables WHERE schemaname='public' and tablename='%s';" % table_name.lower()
    cursor.execute(exists_cmd)
    if cursor.fetchone():
      exists = True
    else:
      exists = False    
  ...
  def _register_record_fields(self,  record):
    ...
    table_name = self.table_name_from_record(record).lower()
  ...
  def write_record(self, record):
    ...
    table_name = self.table_name_from_record(record).lower()
    print(dir(record.fields.keys()))
    print(record.fields.keys())
