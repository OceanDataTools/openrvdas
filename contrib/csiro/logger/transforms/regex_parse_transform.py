...
from contrib.csiro.logger.utils import regex_parser
from logger.transforms.transform import Transform  # noqa: E402
from logger.transforms.parse_transform import ParseTransform


################################################################################
class RegexParseTransform(ParseTransform):
    ...
    def __init__(self, record_format=None, field_patterns=None, metadata=None,
                 definition_path=regex_parser.DEFAULT_DEFINITION_PATH,
        ...
        ```
        """
        self.parser = regex_parser.RegexRecordParser(
