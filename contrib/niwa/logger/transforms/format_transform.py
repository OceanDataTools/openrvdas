#!/usr/bin/env python3
"""
#niwa - Edited to convert numerical timestamp , used by Events Logger
...
class FormatTransform(Transform):
    ...
    def transform(self, record):
        ...
        if type(record) is DASRecord:
          fields['timestamp'] = datetime.fromtimestamp(record.timestamp)
        else:
          fields['timestamp'] = datetime.fromtimestamp(record.get('timestamp', 0))
